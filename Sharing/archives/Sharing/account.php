...
if ($_POST['submit2'] == "Re-save") {
    $query = 'update members set '.
                'member_fname = '.qq($_POST['fname']).' , '.
                'member_lname = '.qq($_POST['lname']).' , '.
                'member_email = '.qq($_POST['email']).' , '.
                'member_password = '.qq($_POST['pagespass']).' , '.
                'member_pcode = '.qq($_POST['pcode']).' '.
                'where member_ID = '.qq($_SESSION['member_ID']);     
    $result = $mysqli -> query($query);
    //echo '<br>your email and password have been re-saved<br>';
